...
export const outcomeReceiptSchema = z.object({
  ...
  ciProvider: z.string().trim().min(1).max(120).nullable().optional(),
  ciRunId: z.string().trim().min(1).max(240).nullable().optional(),
  merged: z.boolean().nullable().optional(),
  deploymentSuccessful: z.boolean().nullable().optional(),
  deploymentProvider: z.string().trim().min(1).max(120).nullable().optional(),
  deploymentId: z.string().trim().min(1).max(240).nullable().optional(),
  deploymentEnvironment: z.string().trim().min(1).max(80).nullable().optional(),
