...
export const MODEL_CATALOG: ModelCatalogEntry[] = [
  ...
  { id: "gemini-3.7-flash", name: "Gemini 3.7 Flash", provider: "Google", tokenizer: "gemini-estimate", tokenizerAccuracy: "estimate", contextWindow: 1_048_576, maxOutput: 65_536, pricing: { input: 1.5, cachedInput: 0.15, output: 7.5 }, pricingEffectiveFrom: "2027-01-01", pricingVersions: [{ id: "gemini-3.7-flash-intro-2026", effectiveFrom: "2026-08-13", effectiveTo: "2026-12-31", pricing: { input: 0.75, cachedInput: 0.075, output: 3.75 }, sourceUrl: "https://ai.google.dev/gemini-api/docs/pricing", verifiedAt: "2026-09-04", label: "Introductory pricing through 2026-12-31", serviceTier: "standard" }], pricingLabel: "Standard pricing from 2027-01-01", sourceUrl: "https://ai.google.dev/gemini-api/docs/models/gemini-3.7-flash", sourceLabel: "Google AI model docs", verifiedAt: "2026-09-04" },
  { id: "gemini-3.6-flash", name: "Gemini 3.6 Flash", provider: "Google", tokenizer: "gemini-estimate", tokenizerAccuracy: "estimate", contextWindow: 1_048_576, maxOutput: 65_536, pricing: { input: 1.5, cachedInput: 0.15, output: 7.5 }, pricingEffectiveFrom: "2027-01-01", pricingVersions: [{ id: "gemini-3.6-flash-intro-2026", effectiveFrom: "2026-08-13", effectiveTo: "2026-12-31", pricing: { input: 0.75, cachedInput: 0.075, output: 3.75 }, sourceUrl: "https://ai.google.dev/gemini-api/docs/pricing", verifiedAt: "2026-09-04", label: "Introductory pricing through 2026-12-31", serviceTier: "standard" }], pricingLabel: "Standard pricing from 2027-01-01", sourceUrl: "https://ai.google.dev/gemini-api/docs/pricing", sourceLabel: "Google AI pricing", verifiedAt: "2026-09-04" },
