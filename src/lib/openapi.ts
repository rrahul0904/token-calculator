...
export const OPENAPI_DOCUMENT = {
  ...
  info: {
    ...
    version: "1.2.0",
    description: "AI economics, model discovery, agent-run telemetry, FinOps, budgets, governed provider gateway and MCP APIs. Measurement provenance is preserved as provider_measured, agent_measured, local_tokenizer_reference, estimated, or reconciled. Prompt/code content is not persisted by default.",
  },
