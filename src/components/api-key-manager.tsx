...
export function ApiKeyManager() {
  ...
  async function refresh() {
    const [keyResponse, projectResponse] = await Promise.all([
  ...
  return <div className="app-stack">
    <section className="app-panel"><div className="app-panel__header"><div><h2>Create key</h2><p>Secrets use 256 bits of randomness and are stored only as salted scrypt hashes. Project restrictions and quotas are enforced server-side.</p></div></div><div className="app-panel__body form-grid">
