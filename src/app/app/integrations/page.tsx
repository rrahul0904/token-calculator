...
import { ProviderUsageImporter } from "@/components/provider-usage-importer";
...
export default async function IntegrationsPage() {
  ...
  return <>
    <AppPageHeader kicker="Collection + control" title="Integrations" description="Start with metadata-only local collectors, then add provider reconciliation, API/MCP instrumentation or a governed gateway when you need authoritative enforcement." actions={<Link className="button button--ghost" href="/developers">Developer setup</Link>} />
    <div className="app-stack">
      <ProviderConnectionsManager />
      <ProviderUsageImporter />
